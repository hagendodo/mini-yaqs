    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('quote-categories.index')" :active="request()->routeIs('quote-categories.index')">
                        {{ __('Quote Categories') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('video-categories.index')" :active="request()->routeIs('video-categories.index')">
                        {{ __('Video Categories') }}
                    </x-nav-link>
                </div>
